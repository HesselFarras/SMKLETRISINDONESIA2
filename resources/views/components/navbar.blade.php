<header class="bg-slate-900 text-white sticky top-0 z-50">
    ...
    <div id="mobile-menu" class="overflow-hidden max-h-0 md:hidden bg-slate-800 transition-all duration-300">
        <div class="px-4 pb-4 space-y-2">
            <a href="/index.html" class="block py-2 border-b border-slate-700">Home</a>
            <a href="/tentang.html" class="block py-2 border-b border-slate-700">Profile</a>
            <a href="/berita.html" class="block py-2 border-b border-slate-700">Berita</a>
            <a href="/jurusan.html" class="block py-2 border-b border-slate-700">Jurusan</a>
            <a href="/ppdb.html" class="block py-2">Pendaftaran</a>
        </div>
    </div>
</header>
